"""
External file from: https://github.com/glefundes/Multimethod-Binarization
Implementation of different binarization methods like WOLF and SAUVOLA.
"""
...
def binarize(img, methods, resize=None, return_original=False, morph_kernel=None, gray=False):
    results = []
